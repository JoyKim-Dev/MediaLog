...
//
//// viewcontroller - Tableview: Secion 3개
//// (section 1: row 1 / section 2: row 1 / section 2: row 2)
//// tableview cell - section 1 row 1: imageview, overview 넣은 셀
////                  section 2 row 1: castinfo (Tableview) 세로스크롤
////.                 section 3 row 1: similar (Collectionview) 가로 스크롤
////                  section 3 row 2: recomm (collectionview) 가로 스크롤
//// 필요 cell: tableview cell 2개, collectionview cell 1개
///// ******구조가 깊어서 일단 보류....
//
//import UIKit
//
...
//    var castData:[Cast] = []
//    // 한 변수로 두 컬렉션 뷰에 다른 값 넣을거라 2차원 배열 활용함.
...
//        super.viewDidLoad()
//        
//        NetworkManager.shared.movieCast(id: dataFromPreviousPage?.id ?? 0) { data in
...
//        //1차 셀
//        self.tableView.register(MediaImageTableViewCell.self, forCellReuseIdentifier: MediaImageTableViewCell.identifier)
//        self.tableView.register(CastTableViewCell.self, forCellReuseIdentifier: CastTableViewCell.identifier)
//        self.tableView.register(MediaCollectionTableViewCell.self, forCellReuseIdentifier: MediaCollectionTableViewCell.identifier)
////        // 1차 셀의 캐스트 테이블뷰셀
////        tableView.register(MediaDetailCastTableViewCell.self, forCellReuseIdentifier: MediaDetailCastTableViewCell.identifier)
////        // 1차 셀의 무비포스터 테이블뷰셀
...
//                cell.configureView(dataFromPreviousPage: dataFromPreviousPage)
//                return cell
//                
//            case 1:
...
//                // MediaCollectionTableViewCell 설정
...
//        
//        let data = movieData[collectionView.tag][indexPath.item]
//        
//        return cell
//    }
//    
